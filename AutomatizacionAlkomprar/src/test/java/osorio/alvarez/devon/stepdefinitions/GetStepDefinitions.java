...
import static osorio.alvarez.devon.tasks.apiservice.EnviarPeticionGet.enviarPeticionGet;
import static osorio.alvarez.devon.utils.ConstantApi.*;

public class GetStepDefinitions extends SetupServiceGet {
